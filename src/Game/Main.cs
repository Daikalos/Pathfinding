...
public class Main : Game
{
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend,
            SamplerState.LinearClamp, null, null, null, camera.WorldMatrix);
        ...
        if (start != null)
            StringUtilities.DrawMiddle(spriteBatch, font, "S", start.Middle, Color.Red, 1.0f);
        if (goal != null)
            StringUtilities.DrawMiddle(spriteBatch, font, "G", goal.Middle, Color.Red, 1.0f);
        ...
        spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend,
            SamplerState.AnisotropicClamp, null, null, null, null);

        buttons.ForEach(b => b.Draw(spriteBatch, camera));

        Color textColor = new Color(140, 210, 250);

        StringUtilities.DrawLeft(spriteBatch, font, "Path: " + currPath, new Vector2(160, 40), textColor, 0.9f);
        StringUtilities.DrawLeft(spriteBatch, font, "Curr:", new Vector2(16, 300), textColor, 0.9f);
        StringUtilities.DrawLeft(spriteBatch, font, "Start:", new Vector2(16, 340), textColor, 0.9f);
        StringUtilities.DrawLeft(spriteBatch, font, "Goal: ", new Vector2(16, 380), textColor, 0.9f);
        StringUtilities.DrawLeft(spriteBatch, font, "Cnt: ", new Vector2(16, 440), textColor, 0.9f);
        StringUtilities.DrawLeft(spriteBatch, font, "Dir: ", new Vector2(16, 480), textColor, 0.9f);

        if (current != null)
            StringUtilities.DrawLeft(spriteBatch, font, current.X + ";" + current.Y, new Vector2(200, 300), textColor, 0.9f);
        if (start != null)
            StringUtilities.DrawLeft(spriteBatch, font, start.X + ";" + start.Y, new Vector2(200, 340), textColor, 0.9f);
        if (goal != null)
            StringUtilities.DrawLeft(spriteBatch, font, goal.X + ";" + goal.Y, new Vector2(200, 380), textColor, 0.9f);

        StringUtilities.DrawLeft(spriteBatch, font, path.Count.ToString(), new Vector2(200, 440), textColor, 0.9f);
        StringUtilities.DrawLeft(spriteBatch, font, dirPath, new Vector2(200, 480), textColor, 0.9f);
